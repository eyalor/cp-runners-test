...
$sql = "SELECT (SUM(run_distance) + SUM(warmup_distance) + SUM(cooldown_distance)) as weekly, count(*) as a FROM  tl_events WHERE (runner_id = :runner_id AND run_date >= :week_start AND run_date <= :week_end)";
